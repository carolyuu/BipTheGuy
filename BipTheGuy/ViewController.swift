...
//  BipTheGuy
//
//  Created by Carol Yu on 2/14/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func imageTapped(_ sender: UITapGestureRecognizer) {
        ...
        let imageWidthShrink: CGFloat = 20 //set constants for shink
        ...
        UIView.animate(withDuration: 0.25, delay: 0.0, usingSpringWithDamping: 0.2, initialSpringVelocity: 10.0, options: []) {
